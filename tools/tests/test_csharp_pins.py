...
KATEGORIE = {
    "A": {
        ...
        ("UiTextTests.cs", 1294), ("UiTextTests.cs", 1307), ("UiTextTests.cs", 1325),
        ("SignallingHudTests.cs", 39),
    },
    "B": {
        ("UiTextTests.cs", 1394), ("UiTextTests.cs", 1395),
    },
}
...
def test_regula_po_ksztalcie_literalu_myli_sie_i_dlatego_jej_nie_ma():
    ...
    assert przepuszczone == [("UiTextTests.cs", 1325)], (
    ...
    assert zlapane_z_b == [("UiTextTests.cs", 1395)], (
...
def test_czytnik_widzi_pin_takze_wtedy_gdy_literal_jest_sklejony():
    ...
    assert len(tresci[("UiTextTests.cs", 1294)]) == 122, (
        "sklejanie literałów przestało działać: %d znaków"
        % len(tresci[("UiTextTests.cs", 1294)]))
    assert len(tresci[("UiTextTests.cs", 1325)]) == 98, (
        len(tresci[("UiTextTests.cs", 1325)]))
...
# Przeliczone z drzewa.
        ...
        # 560 -> 564 (25.09.2026, obserwacja czynnych składów): dwie dokładne
        # wartości przyspieszenia 0.0 i dwa całkowite indeksy obserwacji.
        "razem": 564, "z_tolerancja": 193, "bez_tolerancji": 371,
        "zmiennoprzecinkowe": 214, "zmiennoprzecinkowe_bez_tolerancji": 21,
        "calkowite": 350, "calkowite_z_tolerancja": 0, "tolerancja_zero": 123,
    },
}
...
# 166 -> 168 (25.09.2026, obserwacja czynnych składów): dwa zerowe przyspieszenia.
...
def test_dokladnych_porownan_zmiennoprzecinkowych_jest_168_a_nie_27():
    ...
    # 139 -> 141 (25.09.2026): brak fałszywego przyspieszenia po zmianie składu.
