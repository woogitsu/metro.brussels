...
#: ma dzis **400** deklaracji, wiec stara podloga 200 lezala **200** nizej, czyli 50,0 % populacji,
#: i przepuszczala mutacje, dla ktorych istnieje: wyciecie z wzorca calej galezi na
#: `static readonly` zabiera **90** deklaracji (zostaje **310**) i przy progu 200 PRZECHODZILO.
#:
#: **Rownosci (`== 400`) tu nie ma i nie bedzie**: populacja rosnie z kazdym nowym polem
#: w `src/`, wiec rownosc zapalalaby sie na pracy poprawnej, a taka bramka zostaje
#: wylaczona, nie poprawiona (6.D27). Zapas **70** (17,5 %) jest dobrany POMIAREM
...
#: 199 -> 198). Zapas jest wiec **70** razy glebszy niz najglebszy spadek, jaki to
...
#: `const` **310**, `static readonly` **90**, razem **400**; bez modyfikatora dostepu
#: stoi **45** z nich (`public` 145, `private` 205).
#:
...
#: zabiera **45** deklaracje, zostaje **355** — i SUME przechodzi nawet przy progu 330.
