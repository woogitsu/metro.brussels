...
#: ma dzis **421** deklaracji, wiec stara podloga 200 lezala **221** nizej, czyli 52,5 % populacji,
#: i przepuszczala mutacje, dla ktorych istnieje: wyciecie z wzorca calej galezi na
#: `static readonly` zabiera **93** deklaracji (zostaje **328**) i przy progu 200 PRZECHODZILO.
#:
#: **Rownosci (`== 421`) tu nie ma i nie bedzie**: populacja rosnie z kazdym nowym polem
#: w `src/`, wiec rownosc zapalalaby sie na pracy poprawnej, a taka bramka zostaje
#: wylaczona, nie poprawiona (6.D27). Zapas **91** (21,6 %) jest dobrany POMIAREM
...
#: 199 -> 198). Zapas jest wiec **91** razy glebszy niz najglebszy spadek, jaki to
...
#: `const` **328**, `static readonly` **93**, razem **421**; bez modyfikatora dostepu
#: stoi **53** z nich; pozostale 368 (87,4 % calej populacji) maja modyfikator dostepu.
#:
...
#: zabiera **53** deklaracje, zostaje **368** — i SUME przechodzi nawet przy progu 330.
