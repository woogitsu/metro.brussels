...
# 942 -> 946 (14.09.2026, 6.D207): cztery adresy z pola „Wejście" WLASNEGO bloku tej
...
# (386 -> 387) za `tools/tests/test_all.py` z plotka tego bloku, „Wyjscie" nie drga.
ADRESOW_W_WYKONANYCH = {"Wejście": 946, "Wyjście": 63, "Weryfikacja": 387}
...
# 123 -> 124 (14.09.2026, 6.D207): jedno wywolanie modulu wiecej —
# `test_prose_counts.py` z plotka „Weryfikacji" bloku tej pozycji.
WYWOLAN_W_WYKONANYCH = {"Wejście": 0, "Wyjście": 0, "Weryfikacja": 124}
