...
# 377 -> 378 (17.09.2026, 6.D257): jeden raport dopisany. UWAGA PRZY SCALANIU:
# galaz 6.D256 podnosi te zapadke do tej samej liczby z INNEGO powodu (swojego
# raportu), wiec po scaleniu obu wartosc trzeba PRZELICZYC z katalogu, a nie
# przyjac z ktorejkolwiek strony — to jest ten sam ksztalt, ktory 6.D229 zlapalo
# jako dziewiate starcie tej zapadki.
MIN_REPORTS = 378
