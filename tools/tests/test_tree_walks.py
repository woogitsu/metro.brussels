...
#: Zapadek: 91. **Przybitych: 18, częściowych: 3, WOLNYCH: 68, poza zasięgiem skanu: 2.**
#:
...
ZAPADKI = {
    ...
    "MIN_PODSTAWIEN_W_TESTACH": (WOLNA, "test_dead_constants.py"),
    "MIN_WIAZANYCH_DOMYSLNIE": (WOLNA, "test_dead_constants.py"),
    ...
    # 6.D234: podloga na liczbe typow publicznych `src/Sim/`. WOLNA z tego samego
    # powodu co wyzej: rownosc zapalalaby sie na kazdym nowym typie, czyli na pracy
    # poprawnej, a kompletnosc PRZYPISANIA pilnuje osobny test tej samej bramki.
    "MIN_TYPOW_PUBLICZNYCH": (WOLNA, "test_csharp_type_callers.py"),
    ...
    # gore CELUJACO (6.D27).
    # 6.D266: podloga na populacje drugiego rejestru — progow DANYCH. WOLNA,
    # bo stoi jako prawa strona jednego porownania. Sam rejestr `PROGI_DANYCH`
    # zapadka NIE jest i nie wchodzi tu ani jedna z dwunastu nazw: `ZAPADKA`
    # znaczy `prog bramki`, a tamte to progi danych (decyzja 18.09.2026).
    "MIN_PROGOW_ZNALEZIONYCH": (WOLNA, "test_data_thresholds.py"),
    ...
    "MINIMUM_AKAPITOW": (WOLNA, "test_machine_paragraphs.py"),
    ...
    "MIN_GOLYCH_W_TYCH_ZDANIACH": (WOLNA, "test_one_bold_sentences.py"),
...
def test_kazda_zapadka_ma_klase_i_klasa_zgadza_sie_z_drzewem():
    ...
    # 90 -> 91 (19.09.2026, 6.D285): podloga na liczbe akapitow czytanych
    # w `docs/23-environment.md` — bez niej zbior przypiety zgadza sie z pustka.
    assert len(w_drzewie) == ZAPADEK_RAZEM == 91, (
    ...
    # WOLNYCH 67 -> 68 (19.09.2026, 6.D285): podloga bramki akapitow o maszynie.
    assert (ile[PRZYBITA], ile[CZESCIOWA], ile[WOLNA], ile[POZA_SKANEM]) == (18, 3, 68, 2), (
...
def test_ktore_wolne_zapadki_sa_PRZESADZONE_ksztaltem_a_ktore_zmierzone():
    ...
    # (67, 66) -> (68, 67) (19.09.2026, 6.D285): `MINIMUM_AKAPITOW`, tak samo
    # wylacznie jako prawa strona jednego porownania.
    assert (wolnych, przesadzonych) == (68, 67), (
