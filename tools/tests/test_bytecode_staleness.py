...
#: `tools/tests` **142**, `tools/blender` 29, `tools/track` 23, `tools/ci` 9,
...
#: suma nie widzi.
ROZKLAD_MODULOW = {
    # 139 -> 140 (6.D277) -> 141 (6.D278) -> 142 (6.D279), 18.09.2026: trzy moduly.
    "tools/tests": 142,
    "tools/blender": 29,
    "tools/track": 23,
    "tools/ci": 9,
...
BAJTKOD_PO_COMPILEALL_PLIKI = 213
