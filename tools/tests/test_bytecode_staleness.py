...
#: `tools/tests` **146**, `tools/blender` 29, `tools/track` 23, `tools/ci` 10,
...
#: suma nie widzi.
ROZKLAD_MODULOW = {
    "tools/tests": 146,  # 139 -> 146 (18.09.2026, 6.D277 do 6.D234)
    "tools/blender": 29,
    "tools/track": 23,
...
BAJTKOD_PO_COMPILEALL_PLIKI = 218
