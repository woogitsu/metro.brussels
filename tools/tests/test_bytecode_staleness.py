...
#: `tools/tests` **143**, `tools/blender` 29, `tools/track` 23, `tools/ci` 10,
...
#: suma nie widzi.
ROZKLAD_MODULOW = {
    "tools/tests": 143,  # 139 -> 143 (18.09.2026, 6.D277 do 6.D280)
    "tools/blender": 29,
    "tools/track": 23,
...
BAJTKOD_PO_COMPILEALL_PLIKI = 215
