...
`test_data_thresholds.py` przy 6.D266 — bramka zapalała
...
na czystym drzewie `compileall` daje **7 katalogów i 216 plików**, z tym samym
rozkładem (`tools/tests` 144, `tools/blender` 29, `tools/track` 23, `tools/ci` 10,
