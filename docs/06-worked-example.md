...
`[BAJTKOD] wyczyszczono 7 kat. __pycache__ (205 plikow) pod tools/`, czyli **205 plików
...
przy MB-04 — bramka zapalała się na każdej z tych jedynek sama.)
...
na czystym drzewie `compileall` daje **7 katalogów i 205 plików**, z tym samym
rozkładem (`tools/tests` 134, `tools/blender` 29, `tools/track` 23, `tools/ci` 9,
