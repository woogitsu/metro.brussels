...
`test_digit_boundaries.py` przy 6.D277 — bramka zapalała
...
na czystym drzewie `compileall` daje **7 katalogów i 211 plików**, z tym samym
rozkładem (`tools/tests` 140, `tools/blender` 29, `tools/track` 23, `tools/ci` 9,
