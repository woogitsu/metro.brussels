...
`test_commit_claims.py` przy 6.D279, 215 po dopisaniu
`assert_render_sums.py` i `test_render_sums.py` przy 6.D280, 216 po dopisaniu
...
narzędzi wizualnych pod `tools/blender/` — bramka zapalała
...
na czystym drzewie `compileall` daje **7 katalogów i 222 pliki**, z tym samym
rozkładem (`tools/tests` 147, `tools/blender` 32, `tools/track` 23, `tools/ci` 10,
