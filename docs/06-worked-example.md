...
`[BAJTKOD] wyczyszczono 7 kat. __pycache__ (206 plikow) pod tools/`, czyli **206 plików
...
przy MB-04, 206 po dopisaniu `test_doctor_test_log.py` przy 6.D241 — bramka zapalała
...
na czystym drzewie `compileall` daje **7 katalogów i 206 plików**, z tym samym
rozkładem (`tools/tests` 135, `tools/blender` 29, `tools/track` 23, `tools/ci` 9,
