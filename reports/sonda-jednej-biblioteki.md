...
`MINIMUM_DETAIL_BLOCKS` ma 125. Wartość rośnie dalej przy każdym uzupełnieniu kolejki — 08.09.2026 doszły najpierw cztery bloki 6.D48 … 6.D51 (zapadka 124), a potem 6.D52 z decyzji właściciela o serializacji jobów, i zapadka stoi na **125**. Liczby w blokach pomiarowych niżej zostają przy swoich datach; ten akapit niesie stan bieżący. **Pomiar niżej jest z 07.09.2026 i zostaje taki,
